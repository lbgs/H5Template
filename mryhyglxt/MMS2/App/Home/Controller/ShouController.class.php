...
if(isset($_REQUEST['jingban']) && $_REQUEST['jingban'] != ''){$map['jingban'] =array('EQ', urldecode(I('jingban'))); }
 ...
 $this->assign('leixinglist', $leixinglist); $jingbanlist =  M($this->dbname)->where(array('jingban'=>array('neq','')))->distinct('jingban')->field('jingban')->select();
 $this->assign('jingbanlist', $jingbanlist); 
  ...
  public function _befor_update($data){
   ...
   public function outxls() {
	    ...
	    $headArr=array('ID','所在店铺','标题','收入类型','收款方式','收入金额','经办人','备注详情','审核人','审核状态');
	    $filename='收入记录';
