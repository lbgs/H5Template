...
if(empty($site_config)){
 ...
 if ($site_config < 4) {
	...
	return json(array('code' => 0, 'msg' => '该补丁包需要先升级到1.0.4版本再升级'));
...
//$system::name('AuthRule')->where('id','in','57,68,69,70,71,72')->delete();



        $system::name('system')->where('name', 'version')->setField('value',5);
